...
hexo.extend.filter.register("before_generate", () => {
  ...
  const internalSrc = {
    main: {
      ...
      file: "https://blog.onlyy.vip/js/main.js",
      version,
    },
    utils: {
      name: "hexo-theme-butterfly",
      file: "https://blog.onlyy.vip/js/utils.js",
      version,
    },
    translate: {
      name: "hexo-theme-butterfly",
      file: "https://blog.onlyy.vip/js/tw_cn.js",
      version,
    },
    local_search: {
      name: "hexo-theme-butterfly",
      file: "https://blog.onlyy.vip/js/search/local-search.js",
      version,
    },
    algolia_js: {
      name: "hexo-theme-butterfly",
      file: "https://blog.onlyy.vip/js/search/algolia.js",
      version,
    },
  };
  ...
  const createCDNLink = (data, type, cond = "") => {
    ...
    if (cond === "internal")
      data["main_css"] = "https://blog.onlyy.vip/css/index.css";
    return data;
  };
